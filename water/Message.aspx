<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Message.aspx.cs" Inherits="water.Message" %>
                    ...
                    <div class="panel-body">                    
                        <form name="form1" runat="server">
                            <p>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DB1_28ConnectionString2 %>" SelectCommand="SELECT [no], [content], [date], [name] FROM [Message] ORDER BY [no]"></asp:SqlDataSource>
                                </form>
                    </div>
                </div>
            </div>
